...
const page = ({params}) => {
  ...
  return (data ? <>
    ...
    <div className="mx-5 max-w-[800px] md:mx-auto mt-[-100px] nb-10 ">
   ...
   <h3 className='my-5 text-[18px] font-semibold'>Conclusion</h3>
        <p className="my-3">Managing your lifestyle is a journey that requires commotment and self-awareness.By following this step-by-step </p>
   ...
   <div className="my-24">
    ...
    :<>
   <p className="flex justify-center items-center w-screen h-screen text-7xl"> Not Found Any Data...!</p>
    </>
  )
}
