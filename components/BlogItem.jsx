...
const BlogItem = () => {
  return (
    <div className='max-w-[330px] sm:max-w-[300px] bg-white border border-black hover:shadow-[-7px_7px_0px_#000000]' >
        <Image src={blog_data[0].image} alt='' loading='eager' width={400} height={400} className='border-b border-black'/>
        ...
        <div className="p-5">
            ...
            <div className="inline-flex items-center py-2 font-semibold text-center">
                Read more <Image className='ml-2' src={assets.arrow} alt='' width={12} loading='eager'/>
            </div>
        </div>
    </div>
  )
