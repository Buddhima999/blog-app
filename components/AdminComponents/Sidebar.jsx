    ...
    <div className='flex flex-col bg-slate-100'>
        ...
        <div className="w-28 sm:w-80 h-[100vh] relative py-12 border border-black">
            <div className="w-[50%] sm:w-[80%] absolute right-0 ">
                ...
                <Link href={'/admin/blogList'} className="my-5 flex item-center border border-black gap-3 font-medium px-3 py-2 bg-white shadow-[-5px_5px_0px_#000000]">
                    <Image src={assets.blog_icon} alt='' width={28}/>
                    <p>Blog List</p>
                </Link>
                <Link href={'/admin/subscriptions'} className="my-5 flex item-center border border-black gap-3 font-medium px-3 py-2 bg-white shadow-[-5px_5px_0px_#000000]">
